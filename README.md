GoSNMPServer
======
[![Build Status](https://travis-ci.org/karimra/GoSNMPServer.svg?branch=master)](https://travis-ci.org/karimra/GoSNMPServer)
[![GoDoc](https://godoc.org/github.com/karimra/GoSNMPServer?status.png)](https://godoc.org/github.com/karimra/GoSNMPServer)
[![codecov](https://codecov.io/gh/karimra/GoSNMPServer/branch/master/graph/badge.svg)](https://codecov.io/gh/karimra/GoSNMPServer)
...
```shell
go install github.com/karimra/GoSNMPServer/cmd/gosnmpserver
...
import "github.com/karimra/GoSNMPServer"
import "github.com/karimra/GoSNMPServer/mibImps"
```
...
Serve your own oids
-----
This library provides some common oid for use. See [mibImps](https://github.com/karimra/GoSNMPServer/tree/master/mibImps) for code, See [![GoDoc](https://godoc.org/github.com/karimra/GoSNMPServe/mibImpsr?status.png)](https://godoc.org/github.com/karimra/GoSNMPServer/mibImps) here.
